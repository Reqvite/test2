      ...
      <div className="product-detail-container">
        <div className="product-images-box">
          <div className="image-container">
            <Image
              src={image[0] ? image[index] : image[0]}
...
export const getStaticProps: GetServerSideProps = async (context: any) => {
  ...
  const foundProduct: FoundProduct = keys.reduce(
    (acc: any, key: keyof typeof products) => {
      if (acc) return acc;
      const found: any = products[key].find(
        (product: any) => product.slug === context.params.slug
      );
